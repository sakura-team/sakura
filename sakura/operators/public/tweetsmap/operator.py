...
class TweetsOperator(Operator):
    ...
    def construct(self):
        # inputs
        self.input_stream = self.register_input("Twitter input data")

        # parameters
        self.lng_column_param = self.register_parameter('Input longitude',
            NumericColumnSelection(self.input_stream))
        self.lat_column_param = self.register_parameter('Input latitude',
            NumericColumnSelection(self.input_stream))
        self.date_column_param = self.register_parameter('Input date',
            StrColumnSelection(self.input_stream))
