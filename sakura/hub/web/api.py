...
class GuiToHubAPI:
    ...
    def create_operator_instance(self, dataflow_id, cls_id, gui_data = '', local_streams=None):
        return self.dataflows[dataflow_id].create_operator_instance(
                        cls_id, gui_data=gui_data, local_streams=local_streams)
